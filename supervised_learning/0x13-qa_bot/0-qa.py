...
def question_answer(question, reference):
    ...
    Args:
        ...
        reference: string containing the reference document from
    ...
    answer = tokenizer.convert_tokens_to_string(answer_token)

    if answer is None or answer is "" or question is answer:
        return None
    return answer
